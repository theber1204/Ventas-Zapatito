...
<div class="row">
	<div class="col-sm-4">
		<form id="frmVentasProductos">
			...
			<label>marca</label>
			<textarea readonly="" id="marcaV" name="marcaV" class="form-control input-sm"></textarea>
			<label>modelo</label>
			<textarea readonly="" id="modeloV" name="modeloV" class="form-control input-sm"></textarea>
			<label>Descripcion</label>
			<textarea readonly="" id="descripcionV" name="descripcionV" class="form-control input-sm"></textarea>
			<label>Talla</label>
			<textarea readonly="" id="tallaV" name="tallaV" class="form-control input-sm"></textarea>
		...
		$('#productoVenta').change(function(){
			$.ajax({
				...
				success:function(r){
					...
					$('#marcaV').val(dato['marca']);
					$('#modeloV').val(dato['modelo']);
					$('#descripcionV').val(dato['descripcion']);
					$('#tallaV').val(dato['talla']);
